...
namespace SpyGame
{
    ...
    public class PlayerControlledBrain : Brain
    {
        ...
        public override void Initialize(Thinker thinker)
        {
            ...
            {
                Debug.LogWarning(
                    "Warning: no main camera found. Third person character needs a Camera tagged \"MainCamera\", for camera-relative controls.", thinker);
            ...
            if (m_Character == null)
            {
                Debug.LogError("ThirdPersonCharacter component not found in " + thinker);
            }
        }
        ...
        public override void Stop(Thinker thinker)
        {
